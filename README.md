...
This branch includes NUI (web UI), but does not include SQLite support.
...
Download this branch directly to start from the NUI template variant.

- [Download](https://github.com/DemiAutomatic/fivem-typescript-boilerplate/archive/refs/heads/nui.zip) the template directly.
